...
def add_task():  
    ...
    if len(task_string) == 0:  
        ...
        messagebox.showinfo('Error', 'Your Field is Empty.')  
    else:  
...
def delete_all_tasks():  
    ...
    message_box = messagebox.askyesno('Delete All', 'Are you sure to Delete all ?')  
...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager(Subrato)")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#AAEBD7")  
    functions_frame = tk.Frame(guiWindow, bg = "#AAEBD7")  
    listbox_frame = tk.Frame(guiWindow, bg = "#AAEBD7")  
